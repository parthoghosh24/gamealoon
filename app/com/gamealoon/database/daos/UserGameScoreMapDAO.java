...
public class UserGameScoreMapDAO extends GloonDAO<UserGameScoreMap> implements UserGameScoreMapInterface {
	...
	@Override
	public HashMap<String, String> createOrUpdateScoreMap(String id, String gameId, String username, Double gameScore,
			Double networkUserWeight) {
	...
	private UserGameScoreMap createOrUpdateScoreMapInstance(String id, String gameId, String username, Double gameScore,
			Double networkUserWeight) {
